					...
					<div class="col d-flex flex-row">
						...
						<div class="top_bar_content ml-auto">
							...
							<div class="top_bar_user">
								...
								<div><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Sign in</button></div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col">
						...
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="cat_menu_container">
								...
								<ul class="cat_menu">
								<%!ArrayList<Category> catList1;
														Category category1;
														Iterator<Category> citr1;%>
													<%
													...
													%>
									<li><a href="#"><%=category1.getCategory_name() %> <i class="fas fa-chevron-right ml-auto"></i></a></li>
									<%} %>
								...
								<ul class="standard_dropdown main_nav_dropdown">
									...
									<li class="hassubs">
										...
										<ul>
											...
											<li><a href="blog.jsp">Blog<i class="fas fa-chevron-down"></i></a></li>
											<li><a href="blog_single.jsp">Blog Post<i class="fas fa-chevron-down"></i></a></li>
											<li><a href="regular.jsp">Regular Post<i class="fas fa-chevron-down"></i></a></li>
											<li><a href="cart.jsp">Cart<i class="fas fa-chevron-down"></i></a></li>
...
<% String category_name=request.getParameter("category_name");
	Product catname=new Product();
	catname.setCategory(category_name);
	catname= dao.getProductByCategory(catname);
%>
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="images/shop_background.jpg"></div>
		<div class="home_overlay"></div>
		<div class="home_content d-flex flex-column align-items-center justify-content-center">
			<h2 class="home_title"><%=catname.getCategory() %></h2>
		</div>                           
	</div>
					...
					<div class="shop_sidebar">
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
													<%!ArrayList<Category> catList2;
														Category category2;
														Iterator<Category> citr2;%>
													<%
														catList2 = dao.getAllCategory();
														citr2 = catList2.iterator();

														while (citr2.hasNext()) {
															category2 = citr2.next();
													%>
								<li><a href="#"><%=category2.getCategory_name() %></a></li>
								<%} %>
							</ul>
						</div>
