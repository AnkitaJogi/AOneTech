...
<%
	...
	product = dao.getProductFor(product);
%>
</head>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-2 order-lg-1 order-2">
						<ul class="image_list">
							<li data-image="../AdminOneTech/upload/<%=product.getImage2()%>"><img
								alt="<%=product.getImage2()%>"
								src="../AdminOneTech/upload/<%=product.getImage2()%>"></li>
							<li data-image="../AdminOneTech/upload/<%=product.getImage3()%>"><img
								alt="<%=product.getImage3()%>"
								src="../AdminOneTech/upload/<%=product.getImage3()%>"></li>
							<li data-image="../AdminOneTech/upload/<%=product.getImage4()%>"><img
								alt="<%=product.getImage4()%>"
								src="../AdminOneTech/upload/<%=product.getImage4()%>"></li>
						</ul>
					</div>
						...
						<div class="product_description">
							...
							<div class="product_text">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
									...
									tellus cursus urna, eget dictum lacus turpis.</p>
							</div>
