...
<div class="super_container">
				...
				<div class="row">
					<div class="col d-flex flex-row">
						...
						<div class="top_bar_contact_item">
							...
							<a href="mailto:fastsales@gmail.com">amanthory26@gmail.com</a>
						</div>
						<div class="top_bar_content ml-auto">
							<div class="top_bar_menu">
								<ul class="standard_dropdown top_bar_dropdown">
									...
									<li><a href="#">StartBusiness<i
											class="fas fa-chevron-down"></i></a>
										<ul>
											<li><a href="#" data-toggle="modal"
												data-target="#RegistrationForShop">Register For Shop</a></li>
											<li><a href="#">Get Enquiry</a></li>
										</ul></li>
								</ul>
							</div>
							<div class="top_bar_user">
								...
								%>
								<div>
									<button type="button" class="btn btn-primary"><%=user.getName()%>
									</button>
								</div>
								<%
									} else {
								...
								<div>
									<button type="button" class="btn btn-primary"
										data-toggle="modal" data-target="#exampleModalRegistration">Registration</button>
								</div>
								<%
									}
								%>
								...
								%>
								<div>
									<a href="LogoutAction"><button type="button"
		...
		<!-- Modal is at Last position of page --> <!-- Header Main -->
											...
											<div class="custom_dropdown_list">
												...
												<ul class="custom_list clc">
													...
													<%
														...
														citr = catList.iterator();

														while (citr.hasNext()) {
															category = citr.next();
													%>
													<li><a class="clc" href="#"><%=category.getCategory_name()%></a></li>
													<%
														}
													%>
												</ul>
				...
				<div class="col">
					...
					<div class="main_nav_content d-flex flex-row">
						...
						<div class="cat_menu_container">
							...
							<ul class="cat_menu">
							<%!ArrayList<Category> catList1,subcat;
											Category category1,subcat1;
											Iterator<Category> citr1,sitr;%>
									<%
									catList1 = dao.getAllCategory();
									citr1 = catList1.iterator();
									
									%>
									<%
									while (citr1.hasNext()) {
										category1 = citr1.next();
										%>
										
											
							<li class="hassubs"><a href="#"><i class="fas fa-chevron-right ml-auto"><%=category1.getCategory() %></i></a>
										<ul><%
										subcat=dao.getAllSubCategory();
										sitr=subcat.iterator();
										while(sitr.hasNext()) { subcat1=sitr.next(); %><li><%=subcat1.getSubcategory() %></li><%} %></ul>
										</li>
									<ul>
									<%
									}
						...
						<div class="main_nav_menu ml-auto">
							<ul class="standard_dropdown main_nav_dropdown">
								...
								<li class="hassubs"><a href="#">Pages<i
										class="fas fa-chevron-down"></i></a>
									<ul>
										<li><a href="shop.jsp">Shop<i
												class="fas fa-chevron-down"></i></a></li>
										<li><a href="product.jsp">Product<i
												class="fas fa-chevron-down"></i></a></li>
										<li><a href="blog.jsp">Blog<i
												class="fas fa-chevron-down"></i></a></li>
										<li><a href="blog_single.jsp">Blog Post<i
												class="fas fa-chevron-down"></i></a></li>
										<li><a href="regular.jsp">Regular Post<i
												class="fas fa-chevron-down"></i></a></li>
										<li><a href="cart.jsp">Cart<i
												class="fas fa-chevron-down"></i></a></li>
										<li><a href="contact.jsp">Contact<i
												class="fas fa-chevron-down"></i></a></li>
									</ul></li>
								<li><a href="blog.jsp">Blog<i
										class="fas fa-chevron-down"></i></a></li>
					...
					<div class="col">
						...
						<div class="page_menu_content">
							...
							<ul class="page_menu_nav">
								...
								<li class="page_menu_item"><a href="blog.jsp">blog<i
										class="fa fa-angle-down"></i></a></li>
								<li class="page_menu_item"><a href="contact.jsp">contact<i
										class="fa fa-angle-down"></i></a></li>
							</ul>
					...
					<div
						...
						<div class="featured">
							<div class="tabbed_container">
								<div class="tabs">
									<ul class="clearfix">
										<li class="active" onclick="feature">Featured</li>
										<li onclick="onsale">On Sale</li>
										<li onclick="beatrated">Best Rated</li>
									</ul>
									<div class="tabs_line">
										<span></span>
									</div>
	...
	Iterator<Product> itr;%>
								...
								<!--Feature -->
								<%-- <%
	if(product.getShowin().equalsIgnoreCase("Feature")){ 
	%> --%>
									...
									<div class="featured_slider slider">
										<%
											while (itr.hasNext()) {
												product = itr.next();
										%>
										<div class="featured_slider_item" id="feature" id="feature">
											<div class="border_active"></div>
											<div
												class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
												<a href="product.jsp?product_id=<%=product.getId()%>"><div
														class="product_image d-flex flex-column align-items-center justify-content-center">
														<img alt="<%=product.getImage1()%>"
															src="../AdminOneTech/upload/<%=product.getImage1()%>"
															style="height: 150px; width: 150px; margin-top: 30px; margin-left: 20px;">
													</div></a>
												<div class="product_content">
													...
													<div class="product_name">
														<div>
															<a href="product.jsp"><%=product.getProduct_name()%></a>
														</div>
													</div>
												...
												<ul class="product_marks">
													<li class="product_mark product_discount">-<%=product.getOffer() %></li>
										...
										<div class="row fill_height">
											<div class="col-lg-4 col-md-6 fill_height">
												<div class="banner_2_content">
													...
													<div class="banner_2_text">Lorem ipsum dolor sit
														amet, consectetur adipiscing elit. Maecenas fermentum
														laoreet.</div>
											...
											<div class="arrivals_slider_item">
												...
												<div
													...
													<div class="product_content">
														...
														<div class="product_name">
															<div>
																<a href="product.jsp">Astro M2 Black</a>
															</div>
														</div>
														<div class="product_extras">
															<div class="product_color">
											...
											<div class="arrivals_slider_item">
												...
												<div
													...
													<div class="product_content">
														...
														<div class="product_name">
															<div>
																<a href="product.jsp">Transcend T.Sonic</a>
															</div>
														</div>
														<div class="product_extras">
															<div class="product_color">
															...
															<button class="product_cart_button active">Add
																to Cart</button>
														</div>
													</div>
													<div class="product_fav">
											...
											<div class="arrivals_slider_item">
												...
												<div
													...
													<div class="product_content">
														...
														<div class="product_name">
															<div>
																<a href="product.jsp">Xiaomi Band 2...</a>
															</div>
														</div>
														<div class="product_extras">
															<div class="product_color">
											...
											<div class="arrivals_slider_item">
												...
												<div
													...
													<div class="product_content">
														...
														<div class="product_name">
															<div>
																<a href="product.jsp">Rapoo T8 White</a>
															</div>
														</div>
														<div class="product_extras">
															<div class="product_color">
											...
											<div class="arrivals_slider_item">
												...
												<div
													...
													<div class="product_content">
														...
														<div class="product_name">
															<div>
																<a href="product.jsp">Philips BT6900A</a>
															</div>
														</div>
														<div class="product_extras">
															<div class="product_color">
											...
											<div class="arrivals_slider_item">
												...
												<div
													...
													<div class="product_content">
														...
														<div class="product_name">
															<div>
																<a href="product.jsp">Nokia 3310(2017)...</a>
															</div>
														</div>
														<div class="product_extras">
															<div class="product_color">
											...
											<div class="arrivals_slider_item">
												...
												<div
													...
													<div class="product_content">
														...
														<div class="product_name">
															<div>
																<a href="product.jsp">Rapoo 7100p Gray</a>
															</div>
														</div>
														<div class="product_extras">
															<div class="product_color">
											...
											<div class="arrivals_slider_item">
												...
												<div
													...
													<div class="product_content">
														...
														<div class="product_name">
															<div>
																<a href="product.jsp">Gembird SPK-103</a>
															</div>
														</div>
														<div class="product_extras">
															<div class="product_color">
											...
											<div class="arrivals_slider_item">
												...
												<div
													...
													<div class="product_content">
														...
														<div class="product_name">
															<div>
																<a href="product.jsp">Canon IXUS 175...</a>
															</div>
														</div>
														<div class="product_extras">
															<div class="product_color">
											...
											<div class="arrivals_slider_item">
												...
												<div
													...
													<div class="product_content">
														...
														<div class="product_name">
															<div>
																<a href="product.jsp">Huawei MediaPad...</a>
															</div>
														</div>
														<div class="product_extras">
															<div class="product_color">
										...
										<div
											...
											<div class="bestsellers_content">
												...
												<div class="bestsellers_name">
													<a href="product.jsp">Xiaomi Redmi Note 4</a>
												</div>
									...
									<div class="bestsellers_item discount">
										<div
											...
											<div class="bestsellers_content">
												...
												<div class="bestsellers_name">
													<a href="product.jsp">Samsung J730F...</a>
												</div>
												<div class="rating_r rating_r_4 bestsellers_rating">
													<i></i><i></i><i></i><i></i><i></i>
												</div>
									...
									<div class="bestsellers_item">
										<div
											...
											<div class="bestsellers_content">
												...
												<div class="bestsellers_name">
													<a href="product.jsp">Nomi Black White</a>
												</div>
												<div class="rating_r rating_r_4 bestsellers_rating">
													<i></i><i></i><i></i><i></i><i></i>
												</div>
									...
									<div class="bestsellers_item">
										<div
											...
											<div class="bestsellers_content">
												...
												<div class="bestsellers_name">
													<a href="product.jsp">Samsung Charm Gold</a>
												</div>
												<div class="rating_r rating_r_4 bestsellers_rating">
													<i></i><i></i><i></i><i></i><i></i>
												</div>
									...
									<div class="bestsellers_item discount">
										<div
											...
											<div class="bestsellers_content">
												...
												<div class="bestsellers_name">
													<a href="product.jsp">Beoplay H7</a>
												</div>
												<div class="rating_r rating_r_4 bestsellers_rating">
													<i></i><i></i><i></i><i></i><i></i>
												</div>
									...
									<div class="bestsellers_item">
										<div
											...
											<div class="bestsellers_content">
												...
												<div class="bestsellers_name">
													<a href="product.jsp">Huawei MediaPad T3</a>
												</div>
												<div class="rating_r rating_r_4 bestsellers_rating">
													<i></i><i></i><i></i><i></i><i></i>
												</div>
										...
										<div class="trends_content">
											...
											<div class="trends_info clearfix">
												<div class="trends_name">
													<a href="product.jsp">Jump White</a>
												</div>
								...
								<div class="owl-item">
									<div class="trends_item">
										...
										<div class="trends_content">
											...
											<div class="trends_info clearfix">
												<div class="trends_name">
													<a href="product.jsp">Samsung Charm...</a>
												</div>
												<div class="trends_price">$379</div>
											</div>
										</div>
								...
								<div class="owl-item">
									<div class="trends_item is_new">
										...
										<div class="trends_content">
											...
											<div class="trends_info clearfix">
												<div class="trends_name">
													<a href="product.jsp">DJI Phantom 3...</a>
												</div>
												<div class="trends_price">$379</div>
											</div>
										</div>
										...
										<div class="review_content">
											...
											<div class="review_text">
												<p>Lorem ipsum dolor sit amet, consectetur adipiscing
													elit. Maecenas fermentum laoreet.</p>
											</div>
										</div>
									</div>
								</div>
		...
		<div class="modal fade" id="exampleModalRegistration" tabindex="-1"
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control"
										id="formGroupExampleInput" name="user_name"
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="number" class="form-control" id="inputPassword3"
										name="number" placeholder="Phone no">
								</div>
							</div>
		...
		<!--  Modal is End  -->
		<!-- Registration for shop Modal is start -->

		<div class="modal fade" id="RegistrationForShop" tabindex="-1"
			role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
					...
					<div class="modal-body">
						<form action="ShopRegisterAction" method="post">
							<div class="form-group row">
								<label for="formGroupExampleInput"
									class="col-sm-2 col-form-label">Name</label>
								<div class="col-sm-10">
									<input type="text" class="form-control"
										id="formGroupExampleInput" name="name" placeholder="Name">
								</div>
							</div>
							<div class="form-group row">
								<label for="inputEmail3" class="col-sm-2 col-form-label">Shop
									Number</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="inputEmail3"
										name="shopnumber" placeholder="Shop Number">
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control"
										id="formGroupExampleInput" name="state" placeholder="State">
								</div>
							</div>
							<div class="form-group row">
								<label for="inputEmail3" class="col-sm-2 col-form-label">Type
									Of Business</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="inputEmail3"
										name="business" placeholder="Type Of Business">
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="inputPassword3"
										name="gst" placeholder="GST Number">
								</div>
							</div>
							<div class="form-group row">
								<label for="inputPassword3" class="col-sm-2 col-form-label">TIN
									Number</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="inputPassword3"
		...
		<!-- Registration for shop Modal End -->
